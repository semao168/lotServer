...
do
	if [ "$ip" != "127.0.0.1" ];then
		...
		$BINDIR/$CTLAPP access add tip $ip tport 468
		$BINDIR/$CTLAPP access add tip $ip tport 587
		$BINDIR/$CTLAPP access add tip $ip tport 993
		$BINDIR/$CTLAPP access add tip $ip tport 13300
		$BINDIR/$CTLAPP access add tip $ip tport 13310
		$BINDIR/$CTLAPP access add tip $ip tport 13350
	fi
